...
1. Copy the following subdirectories into your main working directory: `input`, `intermediate`, `output`, `programs`. These will correspond to the organizational structures referred to in all of the scripts.  
